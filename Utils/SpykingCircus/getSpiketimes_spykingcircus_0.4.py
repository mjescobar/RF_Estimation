...
parser.add_argument('--sourceFile',help='file name without .extension.hdf5, generated by SpyKingCircus',type=str, required=True)
...
rename_electrodoes = open('/home/cesar/Codigo/RF_Estimation_local/Utils/SpykingCircus/rename_electronode.txt', 'r')
#rename_electrodoes = open('rename_electronode.txt', 'r')
filename = args.sourceFile+'.result-merged'+args.number+'.hdf5'
clustername = args.sourceFile+'.clusters-merged'+args.number+'.hdf5'
