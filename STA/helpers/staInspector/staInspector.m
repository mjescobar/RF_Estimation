...
function staInspector (unit_file, sta_folder, inicio, limite)
% datos = '001';
...
mkdir([sta_folder,separadorFolder,classfolder]);
...
display(charunit);
carpeta = [sta_folder,separadorFolder,charunit,'_lineal',separadorFolder];
...
%         title(['SNR ',num2str(snr)]);
    ...
    print(fig1,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,charunit,'.png']);
end
%--------------------------------------------------------------------------
...
print(h1,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h1_temp_prof.pdf']);
print(h2,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h2_pca.pdf']);
print(h3,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h3_pca_kmeans.pdf']);
print(h3_3,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h3_3_pca_kmeans.pdf']);
print(h4,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h4_temp_clustered.pdf']);
print(h5,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h5_tp_clusters.pdf']);

print(h1_1,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h1_spline_temp_prof.pdf']);
print(h4_1,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h4_spline_temp_clustered.pdf']);
print(h5_1,'-dpdf',[sta_folder,separadorFolder,classfolder,separadorFolder,'h5_spline_tp_clusters.pdf']);

% PNGS
print(h1,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h1_temp_prof.png']);
print(h2,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h2_pca.png']);
print(h3,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h3_pca_kmeans.png']);
print(h3_3,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h3_3_pca_kmeans.png']);
print(h4,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h4_temp_clustered.png']);
print(h5,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h5_tp_clusters.png']);

print(h1_1,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h1_spline_temp_prof.png']);
print(h4_1,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h4_spline_temp_clustered.png']);
print(h5_1,'-dpng',[sta_folder,separadorFolder,classfolder,separadorFolder,'h5_spline_tp_clusters.png']);
...
save([sta_folder,separadorFolder,classfolder,separadorFolder,'classification.mat'],'table_id','table_id_mini');
%% IMPROVE THE TEMPORAL PROFILE PLOTS:

save([sta_folder,separadorFolder,classfolder,separadorFolder,'all_temp_curves.mat'],'units','charac','idx','tvector','alltempcurves','alltempcurvesinterpolated','SCORE','COEFF','xcurve','ycurve');

end

% snr_inspector
save([sta_folder,separadorFolder,classfolder,separadorFolder,'snr_inspector.mat'],'snr_inspector');
save([sta_folder,separadorFolder,classfolder,separadorFolder,'unit_name_inspector.mat'],'unit_name_inspector');