function [ stim, originalSeed] = stimGenerator( seed_file,first_file,nimag,blocks,outputname ,do_v7 , outputPath);
...
%   large matrix)
%   outputPath: string for the output path.
% 
% OUTPUTS:
...
% >> do_v73=0;
% >> outputPath = 'Exp__2014_05_08-16.01.01';
...
if do_v7
save([outputPath,'stim_mini_',outputname,'.mat'],'stim','-v7');
else 
save([outputPath,'stim_mini_',outputname,'.mat'],'stim','-v7.3');
end
%% validates
