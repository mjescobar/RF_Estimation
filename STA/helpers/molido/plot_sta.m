...
% ------------------------------------------------------------
% This scripts plot figures of STA results for characterize 
% retinal ganglion cells. The founded receptive field are then
% fitted using 2d gaussian fit, resulting STA estimation.
% The STA_SSPY output are matlab files that contains the 3d matrix
% STA.
% This script contains this stages:
% (1) graph all the frames of the resulting SSPY STA
% (2) choose the max peak frame and fit a 2d gaussian and show a 3d graph 
% (3) show the 2d profile with its fitting of the max peak frame
% (4) do the fit for all the frames
%
% RVILLARROEL 2013
% AASTUDILLO 2014
% ------------------------------------------------------------
...
%carpeta = ['STA_datos0001/cell_e_',nombre_cell_grupo,'_lineal/'];
...
subplot(2,2,2); x_lim =get(gca,'xlim'); y_lim =get(gca,'ylim');
