...
#  
#  
#  Performs K-Means clustering using the SCIPY library
...
parser = argparse.ArgumentParser(prog='kmeans_scipy.py',
 description='Performs K-means using the SCIPY library',
