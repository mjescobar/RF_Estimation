#!/usr/bin/env python
#============================================================
# SPIKE TRIGGERED AVERAGE (STA) ALGORITHM
#============================================================
# This script performs STA from a stimuli ensemble (frames) 
# and a vector of time stamps (points) of a hypothetical cell 
# (spike time stamps are the output of a spike sorting stage).
#
# direct inputs:
# DEFINE EACH VALUE FOR DO OR NOT EACH STAGE
# number of the stages to perform the STA algorithm:
#	stage1: get image names = 0
#	stage2: open images and write = 0
#	calculate mean frame = 0
#	algorithm option = 2
#   name of the unit cell (name of the txt file)
#
# Usage example: > python sta_v2_sspy.py 0 0 0 2 C12a
#
# configuration parameters:
#	- stimuli ensemble (png files, frames) in a folder
#	- time stamp of clustered spikes (mat or txt file) 
#		* time stamps are in points
#	- sampling rate
#	- frame presentation time initialization (points)
#	- frame duration in points
#
# outputs:
#	- STA matrix (mat file)
#	- mean STA matrix (mat file)
#	- images for reference (png files)
#
# The script is divided stages or options:
# 	1.- load an image from the stimuli ensemble folder.
#	2.- load the names of all images in stimuli folder 
#	    and save in a list file (txt and mat).
#	3.- load all images from the stimuli ensemble folder
#	    and calculate the mean stimuli (a frame) and save
#	4.- load the spike time stamps file and convert the 
#	    time points in stimuli frame indexes.
#	5.- calculate the STA matrix using the spike time 
#	    frame indexes and load the corresponding 
#	    triggering frames and save the results.
#
# RVILLARROEL 2013
# AASTUDILLO 2014
#============================================================
...
imageruta = args.imagepath
imagefolder = args.imagefolder
imagefiltro = args.imagefilter

# SPIKE TIME STAMPS FOLDER FOR LOAD SPIKE TRAINS
timefolder = args.timefolder
...
#--------------------------------------------------------
cadena_texto = "image_filenames"
print "Loading image names from mat file: ",stafolder+'/'+cadena_texto+'.mat'
